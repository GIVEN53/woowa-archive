...
import christmas.application.discount.WeekendDiscount;
...
class WeekendDiscountTest {
    private final Discount weekendDiscount = new WeekendDiscount();
    ...
    void 주말이_아니면_할인을_적용하지_않는다(int date) {
        ...
        // when
        int discountAmount = weekendDiscount.calculateDiscountAmount(orders, visitDate);
